...
DESKTOP_PREFERENCES_FILENAME = "desktop_preferences.json"
DESKTOP_STATE_FILENAME = "desktop_state.json"
DESKTOP_DEEP_LINK_INBOX_FILENAME = "desktop_deep_links.json"
BACKUP_DIRECTORY_NAME = "backups"
IMPORT_DIRECTORY_NAME = "imports"
UPDATE_DIRECTORY_NAME = "updates"
ROLLBACK_METADATA_FILENAME = "rollback.json"
...
DESKTOP_PREFERENCES_PATH = os.path.join(CONFIG_DIR, DESKTOP_PREFERENCES_FILENAME)
DESKTOP_STATE_PATH = os.path.join(CONFIG_DIR, DESKTOP_STATE_FILENAME)
DESKTOP_DEEP_LINK_INBOX_PATH = os.path.join(CONFIG_DIR, DESKTOP_DEEP_LINK_INBOX_FILENAME)
BACKUP_DIR = os.path.join(CONFIG_DIR, BACKUP_DIRECTORY_NAME)
IMPORT_DIR = os.path.join(CONFIG_DIR, IMPORT_DIRECTORY_NAME)
UPDATE_DIR = os.path.join(CONFIG_DIR, UPDATE_DIRECTORY_NAME)
ROLLBACK_METADATA_PATH = os.path.join(CONFIG_DIR, ROLLBACK_METADATA_FILENAME)
